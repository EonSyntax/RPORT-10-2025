...
const AnimatedGradientLine = ({ isDarkMode, isInView }) => (
...
const Footer = () => {
  ...
  return (
    ...
    >
      ...
      <AnimatedGradientLine isDarkMode={isDarkMode} isInView={isInView} />
      ...
      <div className="relative z-10 px-6 py-16">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <motion.div
  variants={itemVariants}
  className="flex justify-center space-x-6 backdrop-blur-sm"
    ...
    >
      <social.icon size={20} />
            ...
            <motion.div variants={itemVariants} className="space-y-2">
              ...
              >
                &copy; {new Date().getFullYear()} EonSyntax. All rights
                reserved.
              </p>
              <p
                className={`text-xs ${
