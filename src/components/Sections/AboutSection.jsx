...
import SIGNATURE from "../../assets/images/signature2.svg";
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            >
              ...
              >
                When I'm coding, you'll find me exploring new frameworks,
            ...
            <motion.div variants={itemVariants} className="text-center py-8">
              ...
              <div className="flex justify-center">
                <img src={SIGNATURE} alt="Emmanuel" className="w-68" />
              </div>
